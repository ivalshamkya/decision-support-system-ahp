...
@section('container')
    <div class="p-7 bg-white shadow rounded-lg">
        <div class="flex justify-between mb-5">
            <div>
                <h1 class="text-3xl text-slate-900 font-medium mb-1">Data Kelas</h1>
                <h5 class="text-base text-slate-700 mb-5">Dashboard/Data Kelas</h5>
                <a href="{{ route('/dashboard/kelas/add') }}">
                    <button
                        class="bg-blue-600 text-white flex items-center px-3 py-2 rounded-lg hover:bg-blue-700">+ Tambah Kelas</button>
                </a>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left row-border text-gray-500 divide-y divide-gray-300" id="myTable">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b text-center">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ url('/dashboard/kelas/edit/' . $kls->kelas_id) }}}">
                            ...
                            <button type="button" data-modal-target="deleteModal"
                                ...
                                onclick="showDeleteModal({{$kls->kelas_id}})"
    ...
    <div id="deleteModal" tabindex="-1"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form action="{{ route('/dashboard/kelas/delete') }}" method="POST"
    ...
    <script>
        ...
        function showDeleteModal(siswaId) {
            $('#deleteModal input[name="kelas_id"]').val(siswaId);
