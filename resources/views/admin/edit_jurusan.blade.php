...
@section('container')
    <div class="p-7 bg-white shadow rounded-lg">
        ...
        <div class="relative overflow-x-auto px-1 sm:rounded-lg">
            <form action="{{ route('/dashboard/jurusan/update') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="kode_jurusan" value="{{ $jurusan->kode_jurusan }}" name="kode_jurusan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Kode Jurusan.." required>
                </div>
                <div class="mb-6">
                    <label for="nama_jurusan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Jurusan</label>
                    <input type="text" id="nama_jurusan" value="{{ $jurusan->nama_jurusan }}" name="nama_jurusan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nama Jurusan.." required>
                </div>
                <div>
