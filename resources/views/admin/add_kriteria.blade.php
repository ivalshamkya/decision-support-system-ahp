        ...
        <div class="relative overflow-x-auto px-1 sm:rounded-lg">
            <form action="{{ route('/dashboard/kriteria/insert') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="kriteria_id" name="kriteria_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="ID Kriteria.." required>
                </div>
                <div class="mb-6">
                    <label for="nama_kriteria" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kriteria</label>
                    <input type="text" id="nama_kriteria" name="nama_kriteria" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nama Kriteria.." required>
                </div>
                <div>
