...
@section('container')
    <div class="p-7 bg-white shadow rounded-lg">
        <div class="flex justify-between mb-5">
            <div>
                <h1 class="text-3xl text-slate-900 font-medium mb-1">Edit Sub Kriteria</h1>
                <h5 class="text-base text-slate-700 mb-5">Dashboard/Edit Sub Kriteria</h5>
            </div>
        </div>
        <div class="relative overflow-x-auto px-1 sm:rounded-lg">
            <form action="{{ route('/dashboard/subkriteria/update') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="sub_kriteria" value="{{ $subkriteria->sub_kriteria }}" name="sub_kriteria" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Sub Kriteria.." required>
                </div>
                <div class="mb-6">
                    <label for="bobot" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bobot</label>
                    <input type="number" id="bobot" value="{{ $subkriteria->bobot }}" name="bobot" min="0" max="9" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Bobot.." required>
                </div>
                <div>
